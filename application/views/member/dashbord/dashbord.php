              ...
              <div class="widget big-stats-container">
                <div class="widget-content">
                  ...
                  <div id="big_stats" class="cf">
                    ...
                    <div class="widget-content">
              <div class="shortcuts"> 
              <a href="" class="shortcut"><i class="shortcut-icon icon-file"></i><span
                                        class="shortcut-label">Komputer Jaringan</span> </a>
                                         <a href="javascript:;" class="shortcut"><i class="shortcut-icon icon-file"></i><span
                                        class="shortcut-label">Sistem Operasi</span> </a> 
                                         <a href="javascript:;" class="shortcut"><i class="shortcut-icon icon-file"></i><span
                                        class="shortcut-label">Analisis </span> </a>  </div>
              <!-- /shortcuts --> 
            </div>
            <!-- /widget-content --> 
        ...
        <div class="span6">
          <div class="widget">
            <div class="widget-header"> <i class="icon-bookmark"></i>
              <h3>Pilih Soal Ujian E-Learning <?php echo $this->session->userdata('kode_matakuliah'); ?></h3>
            </div>
            <!-- /widget-header -->
            <div class="widget-content">
              <div class="shortcuts">
              ...
              <select name="kode_matakuliah" >
                       <option value="kosong" selected="">Pilih kategori Mata </option>}
               <?php
              $query = $this->db->query("select * from tbl_matakuliah")->result_array();
              ...
              ?>
                ...
                <option value="<?php echo $row['kode_matakuliah']; ?>"><a href="<?php echo base_url().'member/M_soal'; ?>"><?php echo $row['nama_matakuliah']; ?></a></option>
              ...
              <button type="submit" class="btn btn-success ">masuk kategori</button>
            ...
            foreach ($_POST as $key => $value) {
              if($kode_matakuliah == $value){
                $data = array('ujian' => 'ujian',
              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td> Fresh Web Development Resources </td>
                    <td> http://www.egrappler.com/ </td>
                    <td class="td-actions"><a href="javascript:;" class="btn btn-small btn-success"><i class="btn-icon-only icon-ok"> </i></a><a href="javascript:;" class="btn btn-danger btn-small"><i class="btn-icon-only icon-trash"> </i></a></td>
                  </tr>
